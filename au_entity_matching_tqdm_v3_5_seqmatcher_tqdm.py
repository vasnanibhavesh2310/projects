...
def match_entities(
    ...
    bar_all = tqdm(total=len(left_idx), desc="All left rows", unit="row", position=0, leave=True)
    ...
    results = Parallel(n_jobs=n_jobs, prefer="threads")(delayed(process_left)(i) for i in left_idx)
    total_candidates = 0
